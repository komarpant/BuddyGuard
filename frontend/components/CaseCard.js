export default function CaseCard({ caseData }) {
  ...
  const tierColors = {
    critical: { border: "var(--status-critical)", bg: "rgba(179, 69, 61, 0.08)" },
    distress: { border: "var(--status-distress)", bg: "rgba(192, 138, 62, 0.08)" },
    safe: { border: "var(--status-safe)", bg: "rgba(92, 140, 110, 0.08)" },
  };
